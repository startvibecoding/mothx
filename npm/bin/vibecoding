...
const PLATFORM_MAP = {
  'linux-x64-glibc': 'mothx-linux-x64',
  'linux-arm64-glibc': 'mothx-linux-arm64',
  'linux-loong64-glibc': 'mothx-linux-loong64',
  'linux-ppc64-glibc': 'mothx-linux-ppc64le',
  'linux-s390x-glibc': 'mothx-linux-s390x',
  'linux-riscv64-glibc': 'mothx-linux-riscv64',
  'linux-x64-musl': 'mothx-linux-musl-x64',
  'linux-arm64-musl': 'mothx-linux-musl-arm64',
  'darwin-x64': 'mothx-darwin-x64',
  'darwin-arm64': 'mothx-darwin-arm64',
  'win32-x64': 'mothx-win32-x64',
  'win32-arm64': 'mothx-win32-arm64',
  'freebsd-x64': 'mothx-freebsd-x64',
  'freebsd-arm64': 'mothx-freebsd-arm64',
  'openbsd-x64': 'mothx-openbsd-x64',
  'openbsd-arm64': 'mothx-openbsd-arm64',
  'netbsd-x64': 'mothx-netbsd-x64',
};
