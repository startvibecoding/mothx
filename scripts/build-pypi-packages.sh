...
PLATFORMS=(
  "linux-x64|vibecoding-linux-amd64|manylinux_2_17_x86_64"
  "linux-arm64|vibecoding-linux-arm64|manylinux_2_17_aarch64"
  "linux-ppc64le|vibecoding-linux-ppc64le|manylinux_2_17_ppc64le"
  "linux-s390x|vibecoding-linux-s390x|manylinux_2_17_s390x"
  "linux-musl-x64|vibecoding-linux-musl-amd64|musllinux_1_2_x86_64"
  "linux-musl-arm64|vibecoding-linux-musl-arm64|musllinux_1_2_aarch64"
  "darwin-x64|vibecoding-darwin-amd64|macosx_10_15_x86_64"
  "darwin-arm64|vibecoding-darwin-arm64|macosx_11_0_arm64"
  "win32-x64|vibecoding-windows-amd64.exe|win_amd64"
  "win32-arm64|vibecoding-windows-arm64.exe|win_arm64"
)
...
echo ""
echo "Skipped by design: linux-loong64, linux-riscv64, freebsd, openbsd, netbsd"
echo "PyPI/pip platform tags for those targets are not broadly portable; use npm or release archives for them."
echo ""
