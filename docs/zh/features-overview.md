...
VibeCoding 支持 15+ 厂商适配器，包括：

- **国内**：小米、Kimi、MiniMax、Seed、Qianfan、Bailian、Gitee
- **国际**：Google Gemini、Google Vertex、OpenRouter、Together、Groq、Fireworks
...
VibeCoding 使用 JSONL 格式持久化会话历史，支持：
