...
func (gw *Runtime) handleHealth(w http.ResponseWriter, r *http.Request) {
...
func (gw *Runtime) handleStatus(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		http.Error(w, "method not allowed", http.StatusMethodNotAllowed)
		return
	}
...
func (gw *Runtime) handleSessions(w http.ResponseWriter, r *http.Request) {
	gw.mu.RLock()
	dispatcher := gw.dispatcher
	gw.mu.RUnlock()
...
func (gw *Runtime) handleSessionByID(w http.ResponseWriter, r *http.Request) {
	gw.mu.RLock()
	dispatcher := gw.dispatcher
	gw.mu.RUnlock()
...
func (gw *Runtime) handleMemory(w http.ResponseWriter, r *http.Request) {
	gw.mu.RLock()
...
func (gw *Runtime) handlePlatforms(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		http.Error(w, "method not allowed", http.StatusMethodNotAllowed)
		return
	}
