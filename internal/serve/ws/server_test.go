...
func TestNewRuntime(t *testing.T) {
	gw := NewRuntime("localhost:8090", "test-token", "0.1.27")
	if gw == nil {
...
func TestRuntimeConnectionCount(t *testing.T) {
	gw := NewRuntime("localhost:8090", "", "0.1.27")
...
func TestWithAuthValidToken(t *testing.T) {
	gw := NewRuntime("localhost:8090", "secret", "0.1.27")
...
func TestWebSocketReadsApprovalWhileChatIsRunning(t *testing.T) {
	gw := NewRuntime("localhost:0", "", "0.1.27")
...
func TestRuntimeRoutesRegistered(t *testing.T) {
	gw := NewRuntime("localhost:8090", "", "0.1.27")
