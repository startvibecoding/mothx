...
func (gw *Runtime) Start() error {
	log.Printf("serve websocket listening on %s", gw.httpServer.Addr)
...
func (gw *Runtime) withAuth(handler http.HandlerFunc) http.HandlerFunc {
...
func (gw *Runtime) validToken(token string) bool {
