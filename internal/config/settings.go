...
var defaultProviderConfigs = map[string]*ProviderConfig{
	...
	"kimi-coding":           {BaseURL: "https://api.kimi.com/coding", APIKey: "${KIMI_CODING_API_KEY}", API: "anthropic-messages", Headers: map[string]string{"User-Agent": "opencode/1.17.18"}, Models: []ModelConfig{{ID: "k2p7", Name: "Kimi K2.7 Code", Reasoning: true, ContextWindow: 262144, MaxTokens: 32768, Cost: &CostConfig{Input: 0, Output: 0, CacheRead: 0, CacheWrite: 0}, Input: []string{"text", "image"}}, {ID: "kimi-for-coding", Name: "Kimi For Coding", Reasoning: true, ContextWindow: 262144, MaxTokens: 32768, Cost: &CostConfig{Input: 0, Output: 0, CacheRead: 0, CacheWrite: 0}, Input: []string{"text", "image"}}, {ID: "kimi-k2-thinking", Name: "Kimi K2 Thinking", Reasoning: true, ContextWindow: 262144, MaxTokens: 32768, Cost: &CostConfig{Input: 0, Output: 0, CacheRead: 0, CacheWrite: 0}, Input: []string{"text"}}}},
