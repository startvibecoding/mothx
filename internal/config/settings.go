		...
		Providers: map[string]*ProviderConfig{
			"anthropic": &ProviderConfig{
				...
				Models: []ModelConfig{
					...
					{ID: "claude-opus-4-5", Name: "Claude Opus 4.5", Reasoning: true, ContextWindow: 200000, MaxTokens: 64000, Cost: &CostConfig{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25}, Input: []string{"text", "image"}},
					...
					{ID: "claude-opus-4-1", Name: "Claude Opus 4.1", Reasoning: true, ContextWindow: 200000, MaxTokens: 32000, Cost: &CostConfig{Input: 15, Output: 75, CacheRead: 1.5, CacheWrite: 18.75}, Input: []string{"text", "image"}},
					...
					{ID: "claude-opus-4-0", Name: "Claude Opus 4", Reasoning: true, ContextWindow: 200000, MaxTokens: 32000, Cost: &CostConfig{Input: 15, Output: 75, CacheRead: 1.5, CacheWrite: 18.75}, Input: []string{"text", "image"}},
					...
					{ID: "claude-sonnet-4-5", Name: "Claude Sonnet 4.5", Reasoning: true, ContextWindow: 200000, MaxTokens: 64000, Cost: &CostConfig{Input: 3, Output: 15, CacheRead: 0.3, CacheWrite: 3.75}, Input: []string{"text", "image"}},
					...
					{ID: "claude-sonnet-4-0", Name: "Claude Sonnet 4", Reasoning: true, ContextWindow: 200000, MaxTokens: 64000, Cost: &CostConfig{Input: 3, Output: 15, CacheRead: 0.3, CacheWrite: 3.75}, Input: []string{"text", "image"}},
					...
					{ID: "claude-3-5-haiku-latest", Name: "Claude Haiku 3.5", ContextWindow: 200000, MaxTokens: 8192, Cost: &CostConfig{Input: 0.8, Output: 4, CacheRead: 0.08, CacheWrite: 1}, Input: []string{"text", "image"}},
			...
			"openai": &ProviderConfig{
				...
				Models: []ModelConfig{
					...
					{ID: "gpt-5.5-pro", Name: "GPT-5.5 Pro", Reasoning: true, ContextWindow: 1050000, MaxTokens: 128000, Cost: &CostConfig{Input: 30, Output: 180, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-5.4-pro", Name: "GPT-5.4 Pro", Reasoning: true, ContextWindow: 1050000, MaxTokens: 128000, Cost: &CostConfig{Input: 30, Output: 180, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-5.3-chat-latest", Name: "GPT-5.3 Chat", ContextWindow: 128000, MaxTokens: 16384, Cost: &CostConfig{Input: 1.75, Output: 14, CacheRead: 0.175}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-5.2-pro", Name: "GPT-5.2 Pro", Reasoning: true, ContextWindow: 400000, MaxTokens: 128000, Cost: &CostConfig{Input: 21, Output: 168, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-5-pro", Name: "GPT-5 Pro", Reasoning: true, ContextWindow: 400000, MaxTokens: 128000, Cost: &CostConfig{Input: 15, Output: 120, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-5-chat-latest", Name: "GPT-5 Chat", ContextWindow: 128000, MaxTokens: 16384, Cost: &CostConfig{Input: 1.25, Output: 10, CacheRead: 0.125}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-4o-2024-05-13", Name: "GPT-4o (2024-05-13)", ContextWindow: 128000, MaxTokens: 4096, Cost: &CostConfig{Input: 5, Output: 15, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "gpt-4-turbo", Name: "GPT-4 Turbo", ContextWindow: 128000, MaxTokens: 4096, Cost: &CostConfig{Input: 10, Output: 30, CacheWrite: 0}, Input: []string{"text", "image"}},
					{ID: "gpt-4", Name: "GPT-4", ContextWindow: 8192, MaxTokens: 8192, Cost: &CostConfig{Input: 30, Output: 60, CacheWrite: 0}, Input: []string{"text"}},
					...
					{ID: "o3-pro", Name: "o3-pro", Reasoning: true, ContextWindow: 200000, MaxTokens: 100000, Cost: &CostConfig{Input: 20, Output: 80, CacheWrite: 0}, Input: []string{"text", "image"}},
					...
					{ID: "o1-pro", Name: "o1-pro", Reasoning: true, ContextWindow: 200000, MaxTokens: 100000, Cost: &CostConfig{Input: 150, Output: 600, CacheWrite: 0}, Input: []string{"text", "image"}},
				},
			},
			...
			"openrouter": {Vendor: "openrouter", BaseURL: "https://openrouter.ai/api/v1", APIKey: "${OPENROUTER_API_KEY}", API: "openai-chat", Models: []ModelConfig{
				...
				{ID: "z-ai/glm-5", Name: "GLM 5", Reasoning: true, ContextWindow: 202752, MaxTokens: 4096, Cost: &CostConfig{Input: 0.6, Output: 1.9, CacheRead: 0.119}, Input: []string{"text"}},
			...
			"vercel-ai-gateway": {BaseURL: "https://ai-gateway.vercel.sh", APIKey: "${VERCEL_AI_GATEWAY_API_KEY}", API: "anthropic-messages", Models: []ModelConfig{
				...
				{ID: "deepseek/deepseek-v4-flash", Name: "DeepSeek V4 Flash", Reasoning: true, ContextWindow: 1048576, MaxTokens: 65536, Cost: &CostConfig{Input: 0.09, Output: 0.18, CacheRead: 0.02}, Input: []string{"text"}},
				{ID: "deepseek/deepseek-v4-pro", Name: "DeepSeek V4 Pro", Reasoning: true, ContextWindow: 1048576, MaxTokens: 384000, Cost: &CostConfig{Input: 0.435, Output: 0.87, CacheRead: 0.003625}, Input: []string{"text"}},
				{ID: "alibaba/qwen3.6-plus", Name: "Qwen3.6 Plus", Reasoning: true, ContextWindow: 1000000, MaxTokens: 65536, Cost: &CostConfig{Input: 0.325, Output: 1.95, CacheWrite: 0.40625}, Input: []string{"text", "image"}},
				{ID: "minimax/minimax-m3", Name: "MiniMax M3", Reasoning: true, ContextWindow: 1048576, MaxTokens: 4096, Cost: &CostConfig{Input: 0.3, Output: 1.2, CacheRead: 0.06}, Input: []string{"text", "image"}},
				{ID: "moonshotai/kimi-k2.7-code", Name: "Kimi K2.7 Code", Reasoning: true, ContextWindow: 262144, MaxTokens: 262144, Cost: &CostConfig{Input: 0.612, Output: 3.069, CacheRead: 0.1296}, Input: []string{"text", "image"}},
				...
				{ID: "zai/glm-5.2", Name: "GLM 5.2", Reasoning: true, ContextWindow: 1048576, MaxTokens: 131072, Cost: &CostConfig{Input: 1.2, Output: 4.1, CacheRead: 0.2}, Input: []string{"text"}},
			}},
			"mistral": {Vendor: "mistral", BaseURL: "https://api.mistral.ai/v1", APIKey: "${MISTRAL_API_KEY}", API: "openai-chat", Models: []ModelConfig{
				...
				{ID: "devstral-latest", Name: "Devstral (latest)", ContextWindow: 262144, MaxTokens: 262144, Cost: &CostConfig{Input: 0.4, Output: 2, CacheRead: 0.04}, Input: []string{"text"}},
			...
			"cloudflare-workers-ai": {Vendor: "cloudflare-workers-ai", BaseURL: "https://api.cloudflare.com/client/v4/accounts/{ACCOUNT_ID}/ai/v1", APIKey: "${CLOUDFLARE_API_KEY}", API: "openai-chat", Models: []ModelConfig{
				...
				{ID: "@cf/zai-org/glm-5.2", Name: "GLM 5.2", Reasoning: true, ContextWindow: 262144, MaxTokens: 262144, Cost: &CostConfig{Input: 1.4, Output: 4.4, CacheRead: 0.26}, Input: []string{"text"}},
			}},
