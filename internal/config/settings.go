...
var defaultProviderConfigs = map[string]*ProviderConfig{
	...
	"tencent-hy-plan":           {Vendor: "tencent-hy-plan", BaseURL: "https://api.lkeap.cloud.tencent.com/plan/v3", APIKey: "${TENCENT_HY_PLAN_API_KEY}", API: "openai-chat", Models: []ModelConfig{{ID: "hy3", Name: "Hunyuan 3", Reasoning: true, ContextWindow: 262144, MaxTokens: 65536, Input: []string{"text"}}, {ID: "hy3-preview", Name: "Hunyuan 3 Preview", Reasoning: true, ContextWindow: 262144, MaxTokens: 65536, Input: []string{"text"}}}},
	"tencent-hy-plan-anthropic": {Vendor: "tencent-hy-plan", BaseURL: "https://api.lkeap.cloud.tencent.com/plan/anthropic", APIKey: "${TENCENT_HY_PLAN_ANTHROPIC_API_KEY}", API: "anthropic-messages", Models: []ModelConfig{{ID: "hy3", Name: "Hunyuan 3", Reasoning: true, ContextWindow: 262144, MaxTokens: 65536, Input: []string{"text"}}, {ID: "hy3-preview", Name: "Hunyuan 3 Preview", Reasoning: true, ContextWindow: 262144, MaxTokens: 65536, Input: []string{"text"}}}},
